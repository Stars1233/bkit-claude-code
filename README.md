...
- **CC v2.1.94 Compatibility + Frontmatter Integrity (v2.0.9)** - ENH-188 frontmatter hooks dual-fire prevention (24 components), TodoWrite legacy removal (13 files), deploy skill standardized, 6 eval agents permissionMode, self-healing agent corrected, sessionTitle auto-naming (ENH-187), CC v2.1.94+ recommended, 60 consecutive compatible releases (v2.1.34~v2.1.94)
