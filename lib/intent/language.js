...
const AGENT_TRIGGER_PATTERNS = {
  ...
  // v2.1.13 Sprint Management: 4 sprint agents 통합 routing (관점 1-1 A1)
  'sprint-orchestrator': {
    en: ['sprint orchestrator', 'sprint coordination', 'sprint lifecycle', 'sprint cycle'],
    ko: ['스프린트 조율', '스프린트 진행', '스프린트 사이클', '스프린트 오케스트레이션'],
    ja: ['スプリント調整', 'スプリント進行', 'スプリントサイクル'],
    zh: ['冲刺协调', '冲刺进行', '冲刺周期'],
    es: ['orquestador sprint', 'coordinacion sprint', 'ciclo sprint'],
    fr: ['orchestrateur sprint', 'coordination sprint', 'cycle sprint'],
    de: ['Sprint-Orchestrator', 'Sprint-Koordination', 'Sprint-Zyklus'],
    it: ['orchestratore sprint', 'coordinamento sprint', 'ciclo sprint']
  },
