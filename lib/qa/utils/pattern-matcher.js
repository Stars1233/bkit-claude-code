 ...
 * Depth-aware but NOT string/comment aware (documented edge case).
 ...
 * v2.1.9 fix B11: balanced-brace scanner supports nested module.exports objects.
 * @param {string} content - File content
...
function extractExports(content) {
  ...
  // v2.1.9 fix B11: use balanced-brace scanner to support nested objects/arrays.
